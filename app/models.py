...
def seed_data():
    ...
    sample_products = [
        Product(name="Bluetooth Headphones", price=49.99,
                ...
                image_url="https://via.placeholder.com/300x200?text=Headphones", category="Headphones", stock=25),
        Product(name="Portable Bluetooth Speaker", price=29.99,
                description="Water-resistant portable speaker with 8h battery.",
                image_url="https://via.placeholder.com/300x200?text=Speaker", category="Speakers", stock=40),
        Product(name="Smart Watch", price=119.99,
                description="Fitness-focused smart watch with heart-rate monitor.",
                image_url="https://via.placeholder.com/300x200?text=Watch", category="Watches", stock=15),
        Product(name="USB-C Charger", price=15.50,
                description="Fast charging USB-C adapter, 30W.",
                image_url="https://via.placeholder.com/300x200?text=Charger", category="Accessories", stock=100),
    ]
